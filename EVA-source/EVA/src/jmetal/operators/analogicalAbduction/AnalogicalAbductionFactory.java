...
/**
 * Class implementing a factory for analogical operators.
 */
public class AnalogicalAbductionFactory {
   ...
   * @return The operator
   */
  public static AnalogicalAbduction getAnalogicalOperator(String name, HashMap parameters) throws JMException {
    if (name.equalsIgnoreCase("BasicAnalogicalAbduction"))
      return new BasicAnalogicalAbduction(parameters);
    /*else if (name.equalsIgnoreCase("SinglePointCrossover"))
      ...
      Configuration.logger_.severe("AnalogicalAbductionFactory.getAnalogicalAbductionOperator. " +
          "Operator '" + name + "' not found ");
      throw new JMException("Exception in " + name + ".getAnalogicalAbductionOperator()") ;
    } // else        
  } // 
} // 
