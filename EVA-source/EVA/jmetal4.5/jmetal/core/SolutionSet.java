...
public class SolutionSet implements Serializable {
  ...
  public AdditionalInfo additionalInfoSet = null; 
  ...
  public SolutionSet(int maximumSize){    
    ...
    additionalInfoSet = new AdditionalInfo();
  } // SolutionSet
  ...
  */
  ...
  // DA RIMUOVERE 
  public void printAdditionalInfoToFile(String path) {
...
*/
	      ...
	      for (Solution aSolutionsList_ : solutionsList_) {
	          /*if (aSolutionsList_.getAdditionalInfo() != null) {
	        	  pw.println("\nCOST  ");

	          for (int index=0; index<aSolutionsList_.getAdditionalInfo().getCostVector().size();index++){
	        	  pw.println(aSolutionsList_.getAdditionalInfo().getCostVector().get(index).toString());
	          ...
	          if (aSolutionsList_.getAdditionalInfo() != null) {
		          ...
		          for (int index=0; index<aSolutionsList_.getAdditionalInfo().getTimeVector().size();index++){
		        	  pw.println(aSolutionsList_.getAdditionalInfo().getTimeVector().get(index).toString());
		          }
		          }
	        }
	      ...
	      pw.close();
	        ...
	        Configuration.logger_.severe("Error accessing the file");
	        e.printStackTrace();
	      }
  ...
  // DA RIMUOVERE 
  public void printAdditionalInfoSetToFile(String path) {
	  ...
	  try {
		  ...
		  if (this.additionalInfoSet != null)
			  pw.println(this.additionalInfoSet.getTime());
