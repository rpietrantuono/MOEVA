...
public class MutationFactory {
  ...
  public static Mutation getMutationOperator(String name, HashMap parameters) throws JMException{
    ...
    else if (name.equalsIgnoreCase("CoP_SwapMutation"))
        return new CoP_SwapMutation(parameters);
    
    else if (name.equalsIgnoreCase("CoP_NonUniformMutation"))
        return new CoP_NonUniformMutation(parameters);
    
    else if (name.equalsIgnoreCase("CoP_UniformMutation"))
        return new CoP_UniformMutation(parameters);
