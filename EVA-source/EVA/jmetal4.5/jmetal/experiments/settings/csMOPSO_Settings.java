...
import jmetal.metaheuristics.omopso.csMOPSO;
import jmetal.operators.mutation.CoP_NonUniformMutation;
import jmetal.operators.mutation.CoP_UniformMutation;
 ...
 */
public class csMOPSO_Settings extends Settings{
   ...
   * Constructor
   */
  public csMOPSO_Settings(String problem) {
    super(problem) ;
  ...
  public Algorithm configure() throws JMException {
    ...
    algorithm = new csMOPSO(problem_) ;
    ...
    uniformMutation = new CoP_UniformMutation(parameters);
    
    parameters = new HashMap() ;
    parameters.put("probability", mutationProbability_) ;
    parameters.put("perturbation", perturbationIndex_) ;
    parameters.put("maxIterations", maxIterations_) ;
    nonUniformMutation = new CoP_NonUniformMutation(parameters);
