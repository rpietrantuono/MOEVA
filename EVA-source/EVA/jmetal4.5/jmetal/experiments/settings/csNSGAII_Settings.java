 ...
 */
public class csNSGAII_Settings extends Settings {
   ...
   * Constructor
   */
   public csNSGAII_Settings(String problem) {
    super(problem) ;
    ...
    populationSize_              = 100; //50; //12; //18; // 50   ;
    maxEvaluations_              =20000; //500; //9600; //90; //500;
    mutationProbability_         = 1.0/problem_.getNumberOfVariables() ;
    crossoverProbability_        = 0.9   ;
    mutationDistributionIndex_   = 20.0  ;
    crossoverDistributionIndex_  = 40.0  ;
  } // NSGAII_Settings
   ...
   */
    ...
    //crossover = CrossoverFactory.getCrossoverOperator("CoP_PMXCrossover", parameters);
    crossover = CrossoverFactory.getCrossoverOperator("CoP_TwoPointsCrossover", parameters);
    parameters = new HashMap() ;
    parameters.put("probability", mutationProbability_) ;
    parameters.put("distributionIndex", mutationDistributionIndex_) ;
    //mutation = MutationFactory.getMutationOperator("PolynomialMutation", parameters);
    mutation = MutationFactory.getMutationOperator("CoP_SwapMutation", parameters);
