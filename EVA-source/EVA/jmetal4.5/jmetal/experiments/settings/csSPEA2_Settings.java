 ...
 */
public class csSPEA2_Settings extends Settings {
   ...
   * Constructor
   */
  public csSPEA2_Settings(String problem) {
    super(problem) ;
    ...
    populationSize_           = 100;//12; //18; //100   ;
    archiveSize_              = 100; //12 ; //18;  //100   ;
    maxEvaluations_           = 20000; //9600; //90;//240 //2500 ;
